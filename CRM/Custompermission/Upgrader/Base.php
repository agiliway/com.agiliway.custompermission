 ...
 */
class CRM_Custompermission_Upgrader_Base {
  ...
  static public function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Custompermission_Upgrader('com.agiliway.custompermission', realpath(__DIR__ . '/../../../'));
    }
   ...
   *
   * @code
   * CRM_Custompermission_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1',
   *   'arg2');
   * @endcode
   */
  ...
  /**
   * CRM_Custompermission_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
