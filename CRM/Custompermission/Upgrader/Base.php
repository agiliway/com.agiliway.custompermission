...
class CRM_Custompermission_Upgrader_Base {
  ...
  /**
   * @var CRM_Custompermission_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Custompermission_Upgrader(
   ...
   *
   * ```
   * CRM_Custompermission_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
